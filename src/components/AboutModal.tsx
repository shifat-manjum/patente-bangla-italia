...
export const AboutModal: React.FC<AboutModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-fadeIn">
      <div className="relative w-full max-w-2xl bg-white border border-slate-200 rounded-3xl p-6 sm:p-8 space-y-6 shadow-xl max-h-[90vh] overflow-y-auto text-left">
        {/* Close Button */}
        <button
          type="button"
          onClick={onClose}
        ...
        {/* Founder Story Card */}
        <div className="p-6 rounded-3xl bg-slate-50 border border-slate-200 space-y-4 text-left shadow-sm">
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-[#FB6C00] to-[#F9B637] p-0.5 shadow-sm shrink-0">
              <div className="w-full h-full bg-white rounded-[14px] flex items-center justify-center text-xl font-black text-[#FB6C00]">
                SM
              </div>
            </div>
            <div>
              <h3 className="text-lg font-black text-slate-900">Shifat Manjum</h3>
          ...
          <div className="space-y-3 text-xs sm:text-sm text-slate-700 leading-relaxed font-normal pt-2 border-t border-slate-200">
            <p>
            ...
            <p className="text-orange-950 font-semibold bg-orange-100/50 p-3 rounded-xl border border-orange-200">
          ...
          <div className="pt-3 border-t border-slate-200 flex flex-wrap items-center gap-4 text-xs">
            <a
              ...
              className="inline-flex items-center gap-1.5 text-[#FB6C00] hover:text-orange-700 font-bold transition"
            >
            ...
            <a
              ...
              className="inline-flex items-center gap-1.5 text-slate-600 hover:text-slate-900 font-bold transition"
            >
            ...
            <span className="text-slate-500 text-xs">
              ইকোসিস্টেম: <strong className="text-slate-800">Zentixx Store • MyPdfTools</strong>
            </span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 text-left">
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-1.5">
            <div className="w-8 h-8 rounded-xl bg-orange-50 text-[#FB6C00] flex items-center justify-center">
              <Globe className="w-4 h-4" />
            </div>
            <h4 className="text-xs font-black text-slate-900">১০০% ডিজিটাল প্রস্তুতি</h4>
          ...
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-1.5">
            ...
            <h4 className="text-xs font-black text-slate-900">নির্ভুল সরকারি ডেটা</h4>
            <p className="text-[11px] text-slate-500 leading-snug">
          ...
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-1.5">
            ...
            <h4 className="text-xs font-black text-slate-900">বাংলা ভাষাভাষী কমিউনিটি</h4>
            <p className="text-[11px] text-slate-500 leading-snug">
        ...
        <div className="pt-2 text-center">
          <button
            type="button"
            onClick={onClose}
            className="py-3 px-8 rounded-2xl bg-slate-100 hover:bg-slate-200 text-slate-700 font-black text-xs transition cursor-pointer"
          >
            বন্ধ করুন (Chiudi)
          </button>
        </div>
