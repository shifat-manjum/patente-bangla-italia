...
export const ExamSimulator: React.FC<ExamSimulatorProps> = ({
  ...
  if (!isStarted) {
    return (
      <div className="max-w-2xl mx-auto bg-white dark:bg-slate-900 rounded-3xl p-8 sm:p-10 text-center space-y-6 animate-fadeIn border border-slate-200 dark:border-slate-800 shadow-sm">
        <div className="w-16 h-16 rounded-2xl bg-orange-50 dark:bg-orange-950/60 text-[#FB6C00] border border-orange-200 dark:border-orange-900/60 flex items-center justify-center mx-auto shadow-sm">
        ...
        <div className="p-4 rounded-xl bg-orange-50 dark:bg-orange-950/40 border border-orange-200 dark:border-orange-900/60 max-w-xl mx-auto text-xs text-orange-900 dark:text-orange-200 text-left">
        ...
        <button
          ...
          className="py-3.5 px-8 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-black text-base shadow-sm transition-all hover:scale-105 active:scale-95 cursor-pointer"
        >
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-4 animate-fadeIn">
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl p-3.5 sm:p-4 flex flex-wrap items-center justify-between gap-3 border border-slate-200 dark:border-slate-800 shadow-sm transition-colors">
        ...
        <div className="flex items-center gap-2.5">
          {onBackToRounds && (
            <button
              ...
              className="p-2 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 border border-slate-200 dark:border-slate-700 text-xs font-bold transition flex items-center gap-1 cursor-pointer"
        ...
        <div className="flex items-center gap-2.5">
          <div
            className={`py-1.5 px-3 rounded-xl flex items-center gap-1.5 font-black text-sm border ${
              timeLeftSeconds < 180
                ? 'bg-rose-50 dark:bg-rose-950/70 text-rose-700 dark:text-rose-300 border-rose-200 dark:border-rose-900 animate-pulse'
                : timeLeftSeconds < 360
                ? 'bg-orange-50 dark:bg-orange-950/70 text-orange-700 dark:text-orange-300 border-orange-200 dark:border-orange-900'
        ...
        {!isSubmitted ? (
          <button
            ...
            className="py-2 px-4 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-black text-xs shadow-sm hover:scale-105 active:scale-95 transition cursor-pointer"
          >
          ...
          <button
            type="button"
            onClick={startNewExam}
            className="py-2 px-4 rounded-xl bg-slate-900 hover:bg-black dark:bg-slate-800 dark:hover:bg-slate-700 text-white font-black text-xs flex items-center gap-2 transition cursor-pointer"
          >
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl p-2 sm:p-2.5 border border-slate-200 dark:border-slate-800 shadow-xs flex items-center gap-2">
        ...
        <button
          ...
          className="px-2.5 py-1.5 rounded-xl border border-slate-200 dark:border-slate-700 text-[11px] font-bold text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 shrink-0 cursor-pointer flex items-center gap-1"
      ...
      <div className="bg-white dark:bg-slate-900 rounded-2xl p-3.5 sm:p-4 border border-slate-200 dark:border-slate-800 shadow-sm flex items-center justify-between gap-3">
        <button
          type="button"
          disabled={currentIdx === 0}
          onClick={() => setCurrentIdx((prev) => Math.max(0, prev - 1))}
          className="py-3 px-4 sm:px-6 rounded-xl bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-bold text-xs sm:text-sm flex items-center gap-2 border border-slate-200 dark:border-slate-700 transition cursor-pointer disabled:opacity-30 disabled:pointer-events-none"
        >
          <ArrowLeft className="w-4 h-4" />
