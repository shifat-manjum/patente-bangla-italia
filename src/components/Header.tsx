...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-[#0D1117]/95 backdrop-blur-md border-b border-white/10 shadow-sm transition-colors">
      <div className="max-w-[1600px] mx-auto px-[15px] py-3.5 sm:py-5 space-y-3 sm:space-y-4">
        ...
        <div className="flex items-center justify-between gap-3 sm:gap-4 flex-wrap sm:flex-nowrap">
          <div className="flex items-center gap-3 sm:gap-4">
            ...
            <div>
              <div className="flex items-center gap-2 sm:gap-2.5 flex-wrap">
                <span className="font-black text-xl sm:text-3xl tracking-tight text-white">
                  Patente<span className="text-[#FB6C00]">Bangla</span>
                </span>
              </div>
              <p className="text-xs sm:text-[13px] text-slate-400 font-medium hidden sm:block mt-0.5">
                ইতালিয়ান ড্রাইভিং লাইসেন্স স্কুল কুইজ • সহজ বাংলা ব্যাখ্যা ও অডিও
              </p>
              <div className="inline-flex items-center gap-1.5 sm:gap-2 mt-1 px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-full bg-white/5 border border-white/15 text-slate-200 text-[10.5px] sm:text-[12px] font-bold tracking-wide leading-tight">
          ...
          <div className="flex items-center gap-2 sm:gap-3 flex-wrap justify-between sm:justify-end w-full sm:w-auto pt-2.5 sm:pt-0 border-t border-white/10 sm:border-0">
            ...
            {currentUser ? (
              <div className="relative">
                <button
                  ...
                  className="py-2 sm:py-2.5 px-3 sm:px-4 rounded-full bg-white/10 hover:bg-white/15 text-white border border-white/20 text-xs sm:text-sm font-bold transition flex items-center gap-2 cursor-pointer shadow-xs"
                ...
                {isProfileOpen && (
                  <div className="absolute right-0 mt-2 w-72 bg-[#12161F] rounded-2xl shadow-2xl border border-white/10 p-4 space-y-3 z-50 animate-fadeIn text-left">
              ...
              <button
                type="button"
                onClick={onOpenAuth}
                className="py-2 sm:py-2.5 px-3 sm:px-4 rounded-full bg-white/10 hover:bg-white/15 text-white border border-white/20 text-xs sm:text-sm font-bold transition flex items-center gap-2 cursor-pointer shadow-xs active:scale-95"
            ...
            <button
              type="button"
              onClick={onOpenAbout}
              className="py-2 sm:py-2.5 px-3 sm:px-3.5 rounded-full bg-white/5 hover:bg-white/10 text-slate-300 hover:text-white border border-white/10 text-xs sm:text-sm font-bold transition flex items-center gap-1.5 cursor-pointer"
            ...
            <button
              type="button"
              onClick={onOpenAdmin}
              className="py-2 sm:py-2.5 px-2.5 sm:px-3 rounded-full bg-white/5 hover:bg-white/10 text-slate-400 hover:text-white border border-white/10 text-xs sm:text-sm font-bold transition flex items-center gap-1 cursor-pointer"
            ...
            {!isVip ? (
              <div className="flex items-center gap-2 sm:gap-2.5">
                <div className="text-right hidden sm:block">
                  <span className="text-[10px] text-slate-400 block font-bold">Foundation Access</span>
                ...
                <button
                  ...
                  className="py-2 sm:py-2.5 px-4 sm:px-5 rounded-full bg-white hover:bg-slate-100 text-slate-950 font-black text-xs sm:text-sm shadow-md hover:scale-105 active:scale-95 transition cursor-pointer flex items-center gap-1.5 sm:gap-2 shrink-0"
                >
              ...
              <div className="flex items-center gap-2">
                <div className="flex items-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-full bg-white/10 border border-white/20 text-white text-xs sm:text-sm font-black">
                ...
                {onOpenInvoice && (
                  <button
                    ...
                    className="py-2 px-2.5 sm:px-3 rounded-full bg-white/10 hover:bg-white/15 text-white border border-white/20 text-xs font-black transition flex items-center gap-1.5 cursor-pointer shadow-xs"
